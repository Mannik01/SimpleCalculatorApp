    ...
    private void ProcessKeypadInput(KeypadButton keypadButton) {
        ...
        switch (keypadButton) {
            case BACKSPACE: // Handle backspace
                ...
                if (resetInput) // if resetInput is true
                    return;
            ...
            case SQRT:
                ...
                parsedValue = Math.pow(parsedValue, 0.5);
            ...
            default:
                if (Character.isDigit(text.charAt(0))) {
                    if (currentInput.equals("0") || resetInput || hasFinalResult) { // if resetInput, or hasFinalResult, is true
